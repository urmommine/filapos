<div class="min-h-screen grid lg:grid-cols-2 bg-background-light">
    <!-- Left Section: Visuals & Branding -->
    <div class="hidden lg:relative lg:flex lg:flex-col lg:items-center lg:justify-center overflow-hidden bg-slate-900">
        <!-- Background Effects -->
        <div class="absolute inset-0 bg-gradient-to-br from-primary/20 via-slate-900 to-slate-900 z-0"></div>
        <div
            class="absolute top-0 left-0 w-full h-full bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 z-0 mix-blend-overlay">
        </div>
        <div class="absolute -top-24 -left-24 size-96 bg-primary/20 rounded-full blur-[100px] pointer-events-none">
        </div>
        <div
            class="absolute bottom-0 right-0 size-[500px] bg-lime-600/10 rounded-full blur-[120px] pointer-events-none">
        </div>

        <!-- Content -->
        <div class="relative z-10 p-12 text-center max-w-lg">
            <div
                class="mx-auto size-24 bg-gradient-to-tr from-primary to-lime-400 rounded-3xl flex items-center justify-center shadow-[0_0_40px_rgba(132,204,22,0.4)] mb-8 transform rotate-6 hover:rotate-12 transition-transform duration-500">
            ...
            <div class="mt-12 flex items-center justify-center gap-4 text-sm font-medium text-slate-400">
    ...
    <div class="flex items-center justify-center p-6 lg:p-12 relative bg-white">
        <div class="w-full max-w-md space-y-8">
            <!-- Mobile Header to match desktop feel on small screens -->
            <div class="text-center lg:text-left mb-10">
                <div
                    class="lg:hidden mx-auto size-14 bg-primary/10 rounded-2xl flex items-center justify-center text-primary mb-6 border border-primary/20 shadow-[0_0_15px_rgba(132,204,22,0.2)]">
            ...
            <form wire:submit="login" class="space-y-6">
                <div class="space-y-2 group">
                    ...
                    <div class="relative">
                        <span
                            class="absolute left-4 top-3.5 text-slate-400 group-focus-within:text-primary transition-colors material-symbols-outlined text-xl">mail</span>
                        <input type="email" id="email" wire:model="email"
                            ...
                            placeholder="nama@toko.com" autofocus>
                    </div>
                    ...
                    <label class="flex items-center gap-3 cursor-pointer group">
                        <div class="relative flex items-center">
                            <input type="checkbox" wire:model="remember"
                                class="peer h-5 w-5 rounded border-border-muted bg-white text-primary focus:ring-offset-0 focus:ring-primary/50 transition-all checked:bg-primary checked:border-primary cursor-pointer">
                        </div>
                        <span
                            class="text-sm text-slate-600 group-hover:text-slate-900 transition-colors select-none">Ingat
                            saya</span>
                    </label>
                    <!-- Optional: Forgot Password Link -->
                    <!-- <a href="#" class="text-sm font-medium text-primary hover:text-lime-600 transition-colors">Lupa sandi?</a> -->
                </div>
                ...
                <button type="submit"
                    ...
                    <span class="material-symbols-outlined text-lg group-hover:translate-x-1 transition-transform"
                        wire:loading.remove>arrow_forward</span>
                </button>
            </form>
