            ...
            <div class="pos-product-image relative aspect-[4/3] rounded-lg overflow-hidden mb-2 sm:mb-4 bg-slate-100">
                ...
                @if($product->available_stock <= 0)
                    <div class="absolute inset-0 bg-white/60 backdrop-blur-[1px] flex items-center justify-center z-10">
                        <span class="bg-red-500 text-white text-[10px] font-black px-3 py-1.5 rounded-full shadow-lg">
                            HABIS
                        </span>
                    </div>
                @endif
    ...
    @if($products->count() >= $perPage)
        <div class="col-span-full pt-4 flex justify-center">
            <button wire:click="loadMore"
                ...
                <span wire:loading wire:target="loadMore" class="animate-spin material-symbols-outlined text-sm">
                    progress_activity
                </span>
